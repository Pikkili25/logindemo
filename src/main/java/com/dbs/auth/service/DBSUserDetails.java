...
public class DBSUserDetails implements UserDetails{
	
	String userName;
	String password;
	String roles;
	List<GrantedAuthority> authorityList;
	public DBSUserDetails(DBUserEntity dBUserEntity) {
	...
	public void setValues(DBUserEntity dBUserEntity) {
